...
import { ShoppingBag, Heart, BarChart2 } from 'lucide-react';
      ...
      <Link to={`/product/${product.id}`} className="block relative aspect-[4/5] overflow-hidden rounded-xl bg-gray-100">
        ...
        <div className="absolute inset-0 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center p-6 space-x-3">
          ...
          <button
            ...
            className={cn(
              "p-3 rounded-full shadow-lg transition-all transform translate-y-4 group-hover:translate-y-0 duration-300 delay-75",
          ...
          <button
            ...
            className={cn(
              "p-3 rounded-full shadow-lg transition-all transform translate-y-4 group-hover:translate-y-0 duration-300 delay-150",
              isCompared ? "bg-blue-500 text-white" : "bg-white text-black hover:bg-blue-500 hover:text-white"
            )}
          >
            <BarChart2 size={20} />
          </button>
